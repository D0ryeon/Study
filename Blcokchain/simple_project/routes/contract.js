...
module.exports = function(){
    // 해당하는 파일 api의 기본 경로 : localhost:3000/contract

    // localhost:3000/contract 요청 시
    // 등록된 게시글의 목록
    ...
    // 글 내용들을 contract를 이용하여 저장하는 api
    ...
    router.post("/add2", upload.single('_image'),async function(req,res){
        ...
        // smart contract에 있는 함수를 호출하여 데이터를 저장
