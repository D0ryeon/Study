		...
		<form action="./OrderStart.or" name="basketform" method="post">
			...
			<table width="80%" cellpadding="0" cellspacing="0">
				...
				<tr align="center">
					...
					<td><font size="2"><img src="./upload/<%=goods.getGOODS_IMAGE().split(",")[0]%>" width="50" height="50"></font></td>
					<td><font size="2"><%=goods.getGOODS_NAME()%></font></td>
					<td><font size="2"><%=dto.getBASKET_GOODS_AMOUNT()%></font></td>
					<td><font size="2"><%=goods.getGOODS_PRICE()%></font></td>
					<td><font size="2"><a href="BasketDelete.ba?num=<%=dto.getBASKET_NUM()%>" onclick="return confirm('취소하시겠습니까?')">취소</a></font></td>
				</tr>
				<%
					}
				}else{
			...
			<table width="80%" border="0" cellspacing="0" cellpadding="0">
				...
				<%}else{%>
				<a href="./Goods_Detail.go?item=<%=item%>&gr_goods_num=<%=gr_goods_num%>&isitem=<%=isitem%>">
				[계속 쇼핑하기]
				</a>
				<%}%>
				</td>
