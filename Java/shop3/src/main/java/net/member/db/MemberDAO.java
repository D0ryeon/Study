...
public class MemberDAO {
	...
	public void updateMember(MemberBean mb)throws SQLException{
		...
		try {
			sql="update member set MEMBER_PW=?,MEMBER_NAME=?,MEMBER_EMAIL=?,MEMBER_EMAIL_GET=?,MEMBER_MOBILE=?,MEMBER_PHONE,MEMBER_ZIPCODE=?,MEMBER_ADDR1=?,MEMBER_ADDR2=? where MEMBER_ID=?";
