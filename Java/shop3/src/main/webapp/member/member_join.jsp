...
function check(){
	...
	if((forms.MEMBER_ZIPCODE.value=="")||(forms.MEBER_ZIPCODE.value.length<5)){
...
function openConfirmId(joinform){
	...
	open(url,"confirm", "toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=400,height=400");
...
<body>
<table width="960" cellspcting="0" cellpadding="0" border="0" align="center">
	<tr>
		<td colspan=2>
		<!--  회원가입   -->
		...
		<tr>
			...
			<td>
				&nbsp;&nbsp;&nbsp;
				<input type="text" name="MEMBER_JUMIN1" size="12" maxlength="6" onkeypress="gNumCheck()"/>
				<input type="text" name="MEMBER_JUMIN2" size="12" maxlength="7" onkeypress="gNumCheck()"/>
			</td>
		</tr>
		<tr>
			<td bgcolor="#f5f5f5">
		...
		<tr>
			...
			<td>
			&nbsp;&nbsp;&nbsp;
			<input type="text" name="MEMBER_ZIPCODE" size="6" onkeypress="gNumCheck()" maxlength="5"/>
