...
<body>
<div id="wrap">
	<form action="inputUser.jsp" name="userinput" onsubmit="return checkIt()" method="post">
		<h1>회원가입</h1>
		<div id="body">
			<table width="500px;">
				<colgroup>
				...
				<tr>
					...
					<input type="password" name="jumin2" maxlength="7" /></td>
				</tr>
				<tr>
					<th>E-Mail</th>
					<td><input type="text" name="email" class="w300" maxlengt="30" /></td>
				</tr>
				<tr>
					<th>Blog</th>
					<td>
					<input type="text" name="blog" class="w300" maxlength="50" /></td>
		...
		<div id="footer">
			...
			<input type="button" class="inputBtn" value="취 소" onclick="javascript:window.location='main.jsp'" />			
		</div>
	</form>
</div>
